      ...
      <div className="z-10 mx-auto flex w-full max-w-screen-lg flex-col gap-4 px-6">
        <div className="z-10 flex h-full w-full flex-col items-center justify-center gap-4 p-12 md:p-24">
          ...
          <p className="max-w-screen-sm text-center text-lg !leading-normal text-muted-foreground md:text-xl">
            ...
            matérias jornalísticas e muitos outros conteúdos profissionais.{' '}
            <br className="hidden lg:inline-block" />O Speach trás a tecnologia da{' '}
            <span className="font-medium text-primary">Inteligência Artificial</span> com
            a experiência de mais de 1.2 milhões de áudios publicitários gravados.
          </p>
